...
namespace Backend.Migrations
{
    ...
    [Migration("20251008182319_AddMiddleWareLogging")]
    partial class AddMiddleWareLogging
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Backend.Context.testTable", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Backend.DTOs.Paymob_DTOS.AllStudentsDto", b =>
                {
            ...
            modelBuilder.Entity("Backend.Entities.Course", b =>
                {
                    ...
                    b.Property<decimal?>("DurationBDays")
            ...
            modelBuilder.Entity("Backend.Entities.OrderItem", b =>
                {
                    ...
                    b.Property<bool>("IsApplayedVoucher")
                        .HasColumnType("bit");

                    b.Property<int>("OrderId")
                        .HasColumnType("int");

                    b.Property<double>("PriceAfterVoucher")
                        .HasColumnType("float");
            ...
            modelBuilder.Entity("Backend.Entities.OrderTable", b =>
                {
                    ...
                    b.Property<int>("NumberOfTotalItems")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Backend.Entities.Payment", b =>
                {
                    ...
                    b.Property<int>("PaymentProviderUsed")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Backend.Entities.SystemLog", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int?>("LogHappenIn")
                        .HasColumnType("int");

                    b.Property<int?>("LogHappenInId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Backend.Entities.VedioesDetails", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<string>("EnableDownloadedUrl")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<int>("VedioUploadedBy")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Backend.Entities.Voucher", b =>
                {
                    ...
                    b.Property<string>("TargetCourses")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("Backend.MiddleWare.ActivityLog", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Backend.Entities.OrderItem", b =>
                {
                    ...
                    b.HasOne("Backend.Entities.OrderTable", "Order")
                        .WithMany("OrderItems")
