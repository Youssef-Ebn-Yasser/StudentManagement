//│   ├── MeetingLobby.jsx              // Component for joining/creating meeting (pre-meeting)
//This component will serve as the initial screen where users decide whether to create a new meeting 
//(typically a teacher) or join an existing one (typically a student). It will also handle input 
//for the user's display name.

import { fetchActiveMeetings } from '@/api/meetingService';
...
function MeetingLobby({ userName, setUserName, onJoinMeeting, onCreateMeeting, isLoadingToken }) {
    ...
    useEffect(()=>{
        // Fetch active meetings from your backend (simulated for now)
