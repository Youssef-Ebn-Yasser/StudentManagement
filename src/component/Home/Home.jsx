    ...
    >
        ...
        <div className="p-3 lg:p-4 flex-1 flex flex-col">
            <div className="flex justify-between items-center mb-2">
                <span className="text-gray-500 text-xs lg:text-sm truncate max-w-[60%]">
                    {course.title}
                </span>
                {course.level && (
    ...
    const CourseSection = ({
        ...
        <>
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-4 sm:mb-6 px-2 sm:px-0">
                <h2 className="text-2xl sm:text-3xl font-bold text-black mb-2 sm:mb-0">
                    {title}
                </h2>
                <Link
                    to={`/courses`}
