        ...
        <div className='flex flex-col justify-center'>
            <div className='flex flex-col h-full relative'>
                ...
                <div className='adminCard relative w-[100%] bg-white rounded-xl shadow-lg p-6 mt-[-75px] z-10 flex flex-col items-center'>
                        ...
                        <p>
                            <img src={stuImg} alt="stuImg" className='w-5 inline' /><span className='text-indigo-500 font-medium'>{!loading?(<>{students && students.length}</>):<Loader/>}</span> Students &nbsp;
                            <img src={teaImg} alt="stuImg" className='w-5 inline' /><span className='text-indigo-500 font-medium'>{!loading?(<>{teachers && teachers.length}</>):<Loader/>}</span> Teachers &nbsp;
                            <img src={courseImg} alt="stuImg" className='w-5 inline' /><span className='text-indigo-500 font-medium'>{!loading?(<>{courses && courses.length}</>):<Loader/>}</span> Courses &nbsp;
