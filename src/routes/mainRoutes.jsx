...
const routesConfig = [
    ...
    // All other routes wrapped in Layout
    {
        ...
        children: [
            ...
            { path: 'admin/all-admins', element: <AllAdmins/>, isProtected: false, accessRole: 'all' },
            { path: 'admin/addslider', element: <AddSlider/>, isProtected: false, accessRole: 'all' },
            { path: 'admin/all-sliders', element: <AllSliders/>, isProtected: false, accessRole: 'all' },
            { path: 'admin-claims', element: <AdminsClaims/>, isProtected: false, accessRole: 'all' },
